        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    audit_log_id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    entity_name = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    entity_id = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    action = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: false),
                    old_values = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    new_values = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    qualification = table.Column<string>(type: "NVARCHAR2(150)", maxLength: 150, nullable: false),
                    ...
                    specialization = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name_ar = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: false),
                    name_en = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: false),
                    description_ar = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    description_en = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    report_text = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    created_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    created_by_user_id = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    updated_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    updated_by_user_id = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    beneficiary = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: false),
                    status = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    completion_rate = table.Column<decimal>(type: "DECIMAL(5,2)", precision: 5, scale: 2, nullable: false),
                    documentation_path = table.Column<string>(type: "NVARCHAR2(500)", maxLength: 500, nullable: false),
                    ...
                    rejection_reason = table.Column<string>(type: "NVARCHAR2(500)", maxLength: 500, nullable: false),
                    department_id = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: false, defaultValue: "Draft"),
                    checksum = table.Column<string>(type: "NVARCHAR2(64)", maxLength: 64, nullable: true),
                    description = table.Column<string>(type: "NVARCHAR2(500)", maxLength: 500, nullable: true),
                    category = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false, defaultValue: "General"),
                    created_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    created_by_user_id = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    updated_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    updated_by_user_id = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    general_feedback = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    strength_points = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    improvement_areas = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    created_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    created_by_user_id = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    updated_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    updated_by_user_id = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    change_reason = table.Column<string>(type: "NVARCHAR2(500)", maxLength: 500, nullable: false),
                    changed_at = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
                {
